...
interface APIRequestLoadingProps {
  message?: string;
  submessage?: string;
...
interface IdeaAnalysisLoadingProps {
  currentStep?: number;
  totalSteps?: number;
}
...
export const APIRequestLoading = ({
  ...
  variant = "default",
}: APIRequestLoadingProps) => {
  const variants: Record<
    NonNullable<APIRequestLoadingProps["variant"]>,
    string
  > = {
...
export const IdeaAnalysisLoading = ({
  currentPhase = 0,
}: {
  currentPhase?: number;
}) => {
