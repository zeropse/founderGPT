              ...
              <CardContent>
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-violet-100 dark:bg-violet-900">
                      {currentPlanState ? (
                        ...
                        <Sparkles className="h-5 w-5 text-gray-600 dark:text-white" />
                      )}
                    </div>
                    <div>
                  ...
                  <div className="text-right">
                    <DynamicPricing
                      type={currentPlanState ? "premium" : "basic"}
                    />
                  ...
                  >
                    <Card
                      className={`h-full ${
                        ...
                        (!currentPlanState && plan.id === "basic")
                    ...
                    >
                      ...
                      <CardHeader className="text-center pb-4">
                        ...
                        <div className="mt-4">
                          <DynamicPricingLarge
                            type={plan.id === "premium" ? "premium" : "basic"}
                            period={plan.period}
                          />
                        </div>
                      </CardHeader>
