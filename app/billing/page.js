...
import { AlertCircle, CheckCircle, CreditCard, Loader2, Sparkles } from "lucide-react";
...
export default function BillingPage() {
  ...
  return (
    ...
    >
      <motion.div variants={itemAnimation} className="flex justify-between items-center mb-8">
        <div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <motion.div variants={itemAnimation}>
          <Card className={`border-2 ${!isPremium ? "border-primary" : ""} transition-all hover:shadow-lg`}>
            <CardHeader>
        ...
        {/* Premium Plan */}
        <motion.div variants={itemAnimation}>
          <Card className={`border-2 ${isPremium ? "border-violet-500" : ""} transition-all hover:shadow-lg`}>
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
            ...
            <CardContent>
              ...
              {!isPremium ? (
                <Button 
                  className="w-full mt-6 bg-gradient-to-r from-violet-500 to-indigo-500 hover:opacity-90 transition-opacity" 
          ...
          <Card className="border-2">
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 bg-muted/50 rounded-lg border-2 transition-all hover:border-violet-500/50">
              ...
              {isPremium && (
                <motion.div 
                  ...
                  className="mt-4 p-4 bg-gradient-to-r from-violet-500/5 to-indigo-500/5 rounded-lg border-2 border-violet-500/20"
                >
